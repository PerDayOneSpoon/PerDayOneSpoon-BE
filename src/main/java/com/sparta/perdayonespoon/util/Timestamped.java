...
//    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd일 HH시mm분ss초", timezone = "Asia/Seoul")

    @JsonFormat(shape = JsonFormat.Shape.STRING, pattern = "yyyy-MM-dd일")
    @CreatedDate //생성시간
